...
public class BallManager {
    ...
    // SỬA: Chuyển thành final để đảm bảo tốc độ không thay đổi
    ...
    public BallManager(Canvas canvas, Paddle paddle, BrickManager brickManager, GameScreen gameScreen, ItemManager itemManager) {
        ...
        this.ball = new Ball(defaultX, defaultY, ball_radius, ballImage, ball_speed);
    ...
    private void renderAllBalls(GraphicsContext gc) {
        for (Ball currentBall : balls) {
    ...
    public void resetToDefault() {
        ...
        this.ball = new Ball(defaultX, defaultY, ball_radius, normalBallImage, ball_speed);
        ball.setPaddle(paddle);
        balls.add(ball);
    ...
    public void restartGame() {
        ...
        // Reset bóng với tốc độ mặc định
        resetToDefault();
